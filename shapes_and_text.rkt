...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname shapes_and_text) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
;;(overlay (text "CHILL" 50 "white")
;;       (regular-polygon 60 8 "solid" "blue"))
